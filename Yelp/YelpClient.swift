...
private let yelpConsumerKey = "vxKwwcR_NMQ7WaEiQBK_CA"
private let yelpConsumerSecret = "33QCvh5bIF5jIHR5klQr7RtBDhQ"
private let yelpToken = "uRcRswHFYa1VkDrGV6LAW2F8clGh5JHV"
private let yelpTokenSecret = "mqtKIxMIR4iBtBPZCmCLEb-Dz3Y"
...
class YelpClient: BDBOAuth1RequestOperationManager {
    ...
    func searchWithTerm(_ term: String, sort: YelpSortMode?, categories: [String]?, deals: Bool?, distance: Double?, offset: Int?, completion: @escaping ([Business]?, Error?) -> Void) -> AFHTTPRequestOperation {
